    ...
    useEffect(() => {
        const autorun = async () => {
            const res = await fetch(
                "https://Stepwise-backend.onrender.com/api/homepg/allevents",
                {
                    method: "GET",
                    headers: {
            ...
            const resspecial = await fetch(
                "https://Stepwise-backend.onrender.com/api/homepg/specialevents",
                {
                    method: "GET",
                    headers: {
                        "Content-Type": "application/json",
    ...
    const RenderAbstractConfirmButton = ({ eventID }) => {
        ...
        useEffect(() => {
            const fetchData = async () => {
                const res = await fetch(
                    "https://Stepwise-backend.onrender.com/api/generaluser/checkforlikeevent",
                    {
                        method: "POST",
                        headers: {
                            "Content-Type": "application/json",
        ...
        const handleLike = async () => {
            await fetch("https://Stepwise-backend.onrender.com/api/generaluser/likeevent", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                    "auth-token": localStorage.getItem("token"),
