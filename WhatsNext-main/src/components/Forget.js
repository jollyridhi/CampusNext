...
const Forget = ({theme}) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const res = await fetch("https://Stepwise-backend.onrender.com/api/auth/getuserbyemail",
        {
            method: "POST",
            headers: {
        ...
        const response = await fetch(
            "https://Stepwise-backend.onrender.com/api/auth/generateotpforrecovery",
            {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
  ...
  const [success, setSuccess] = useState(false);
    const handlechangepass= () => {
        ...
        fetch("https://Stepwise-backend.onrender.com/api/auth/changepass", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
